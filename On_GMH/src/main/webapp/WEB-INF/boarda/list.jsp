...
<ul class="nav nav-tabs">
	<li class="nav-item"><a class="nav-link active" aria-current="page" href="#nav-1">자주 찾는 질문</a></li>
	<li class="nav-item"><a class="nav-link" href="#nav-2">회원</a></li>
	<li class="nav-item"><a class="nav-link" href="#nav-3">클래스 이용</a></li>
	<li class="nav-item"><a class="nav-link" href="#nav-4">학습</a></li>
	<li class="nav-item"><a class="nav-link" href="#nav-5">강좌 관리</a></li>
	<li class="nav-item"><a class="nav-link" href="#nav-6">기타</a></li>
</ul>
